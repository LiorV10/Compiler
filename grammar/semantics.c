...
AbstractSyntaxTreeNode *_$1 = PopStack(semanticStack);
AbstractSyntaxTreeNode *_$0 = PopStack(semanticStack);
MakeAbstractSyntaxTree(&_$_$); _$_$->info = _$1->info; *SetAbstractSyntaxTreeNodeChild(_$_$) = _$4; ((Symbol*)_$1->info)->_type = _$0; 
return _$_$;
}
...
AbstractSyntaxTreeNode* Semantic_68(void *scopeStack, Stack *semanticStack)
{
// struct_declaration
AbstractSyntaxTreeNode *_$_$ = NULL;
AbstractSyntaxTreeNode *_$2 = PopStack(semanticStack);
...
AbstractSyntaxTreeNode* Semantic_73(void *scopeStack, Stack *semanticStack)
{
// struct_or_union_specifier
AbstractSyntaxTreeNode *_$_$ = NULL;
AbstractSyntaxTreeNode *_$1 = PopStack(semanticStack);
...
AbstractSyntaxTreeNode* Semantic_83(void *scopeStack, Stack *semanticStack)
{
// init_declarator
AbstractSyntaxTreeNode *_$_$ = NULL;
AbstractSyntaxTreeNode *_$0 = PopStack(semanticStack);
...
AbstractSyntaxTreeNode* Semantic_91(void *scopeStack, Stack *semanticStack)
{
// expression
AbstractSyntaxTreeNode *_$_$ = NULL;
AbstractSyntaxTreeNode *_$0 = PopStack(semanticStack);
...
AbstractSyntaxTreeNode* Semantic_96(void *scopeStack, Stack *semanticStack)
{
// assignment_operator
AbstractSyntaxTreeNode *_$_$ = NULL;
AbstractSyntaxTreeNode *_$0 = PopStack(semanticStack);
...
AbstractSyntaxTreeNode* Semantic_102(void *scopeStack, Stack *semanticStack)
{
// and_expression
AbstractSyntaxTreeNode *_$_$ = NULL;
AbstractSyntaxTreeNode *_$2 = PopStack(semanticStack);
...
rules[67]->semanticAction = Semantic_70;
rules[68]->semanticAction = Semantic_69;
rules[69]->semanticAction = Semantic_73;
rules[71]->semanticAction = Semantic_71;
rules[74]->semanticAction = Semantic_80;
rules[75]->semanticAction = Semantic_79;
rules[76]->semanticAction = Semantic_78;
rules[77]->semanticAction = Semantic_77;
rules[78]->semanticAction = Semantic_76;
rules[79]->semanticAction = Semantic_75;
rules[80]->semanticAction = Semantic_74;
rules[81]->semanticAction = Semantic_84;
rules[82]->semanticAction = Semantic_83;
rules[83]->semanticAction = Semantic_86;
...
rules[91]->semanticAction = Semantic_96;
rules[95]->semanticAction = Semantic_92;
rules[96]->semanticAction = Semantic_99;
rules[99]->semanticAction = Semantic_104;
...
rules[136]->semanticAction = Semantic_141;
