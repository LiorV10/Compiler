...
PushLinearLinkedList(&rule_22->expressions);
rule_22->expressions->info = LEFT_CURLYexpression;
PushLinearLinkedList(&compound_statement->rules);
...
PushLinearLinkedList(&rule_23->expressions);
rule_23->expressions->info = LEFT_CURLYexpression;
PushLinearLinkedList(&compound_statement->rules);
...
rule_26->expressions->info = expression_statementexpression;
PushLinearLinkedList(&statement->rules);
...
rule_27->expressions->info = selection_statementexpression;
PushLinearLinkedList(&statement->rules);
...
rule_28->expressions->info = iteration_statementexpression;
PushLinearLinkedList(&statement->rules);
...
PushLinearLinkedList(&rule_31->expressions);
rule_31->expressions->info = COMMAexpression;
PushLinearLinkedList(&rule_31->expressions);
rule_31->expressions->info = initializer_listexpression;
PushLinearLinkedList(&initializer_list->rules);
initializer_list->rules->info = rule_31;
Rule *rule_32 = malloc(sizeof(Rule));
InitLinearLinkedList(&rule_32->expressions);
rule_32->nonTerminal = initializer;
PushLinearLinkedList(&rule_32->expressions);
rule_32->expressions->info = assignment_expressionexpression;
PushLinearLinkedList(&initializer->rules);
initializer->rules->info = rule_32;
...
rule_33->expressions->info = RIGHT_CURLYexpression;
PushLinearLinkedList(&rule_33->expressions);
rule_33->expressions->info = initializer_listexpression;
PushLinearLinkedList(&rule_33->expressions);
rule_33->expressions->info = LEFT_CURLYexpression;
PushLinearLinkedList(&initializer->rules);
...
PushLinearLinkedList(&rule_34->expressions);
rule_34->expressions->info = COMMAexpression;
PushLinearLinkedList(&rule_34->expressions);
...
rule_35->nonTerminal = direct_abstract_declarator;
PushLinearLinkedList(&rule_35->expressions);
rule_35->expressions->info = RIGHT_PARENexpression;
PushLinearLinkedList(&rule_35->expressions);
rule_35->expressions->info = abstract_declaratorexpression;
PushLinearLinkedList(&rule_35->expressions);
rule_35->expressions->info = LEFT_PARENexpression;
PushLinearLinkedList(&direct_abstract_declarator->rules);
direct_abstract_declarator->rules->info = rule_35;
...
rule_36->expressions->info = RIGHT_BRACKETexpression;
PushLinearLinkedList(&rule_36->expressions);
rule_36->expressions->info = LEFT_BRACKETexpression;
PushLinearLinkedList(&direct_abstract_declarator->rules);
...
PushLinearLinkedList(&rule_37->expressions);
rule_37->expressions->info = constant_expressionexpression;
PushLinearLinkedList(&rule_37->expressions);
...
PushLinearLinkedList(&rule_38->expressions);
rule_38->expressions->info = direct_abstract_declaratorexpression;
PushLinearLinkedList(&direct_abstract_declarator->rules);
...
rule_40->expressions->info = RIGHT_PARENexpression;
PushLinearLinkedList(&rule_40->expressions);
rule_40->expressions->info = LEFT_PARENexpression;
PushLinearLinkedList(&direct_abstract_declarator->rules);
...
PushLinearLinkedList(&rule_41->expressions);
rule_41->expressions->info = parameter_type_listexpression;
PushLinearLinkedList(&rule_41->expressions);
...
PushLinearLinkedList(&rule_42->expressions);
rule_42->expressions->info = direct_abstract_declaratorexpression;
PushLinearLinkedList(&direct_abstract_declarator->rules);
...
PushLinearLinkedList(&rule_43->expressions);
rule_43->expressions->info = parameter_type_listexpression;
PushLinearLinkedList(&rule_43->expressions);
...
rule_44->nonTerminal = abstract_declarator;
PushLinearLinkedList(&rule_44->expressions);
rule_44->expressions->info = pointerexpression;
PushLinearLinkedList(&abstract_declarator->rules);
abstract_declarator->rules->info = rule_44;
...
rule_45->expressions->info = direct_abstract_declaratorexpression;
PushLinearLinkedList(&abstract_declarator->rules);
...
rule_48->expressions->info = abstract_declaratorexpression;
PushLinearLinkedList(&rule_48->expressions);
...
rule_49->nonTerminal = identifier_list;
PushLinearLinkedList(&rule_49->expressions);
rule_49->expressions->info = IDENTIFIERexpression;
PushLinearLinkedList(&identifier_list->rules);
identifier_list->rules->info = rule_49;
...
PushLinearLinkedList(&rule_50->expressions);
rule_50->expressions->info = COMMAexpression;
PushLinearLinkedList(&rule_50->expressions);
rule_50->expressions->info = identifier_listexpression;
PushLinearLinkedList(&identifier_list->rules);
identifier_list->rules->info = rule_50;
Rule *rule_51 = malloc(sizeof(Rule));
InitLinearLinkedList(&rule_51->expressions);
rule_51->nonTerminal = parameter_declaration;
PushLinearLinkedList(&rule_51->expressions);
rule_51->expressions->info = declaratorexpression;
PushLinearLinkedList(&rule_51->expressions);
rule_51->expressions->info = declaration_specifiersexpression;
PushLinearLinkedList(&parameter_declaration->rules);
parameter_declaration->rules->info = rule_51;
...
rule_52->expressions->info = abstract_declaratorexpression;
PushLinearLinkedList(&rule_52->expressions);
...
rule_54->nonTerminal = parameter_list;
PushLinearLinkedList(&rule_54->expressions);
rule_54->expressions->info = parameter_declarationexpression;
PushLinearLinkedList(&parameter_list->rules);
parameter_list->rules->info = rule_54;
...
PushLinearLinkedList(&rule_55->expressions);
rule_55->expressions->info = COMMAexpression;
PushLinearLinkedList(&rule_55->expressions);
rule_55->expressions->info = parameter_listexpression;
PushLinearLinkedList(&parameter_list->rules);
parameter_list->rules->info = rule_55;
Rule *rule_56 = malloc(sizeof(Rule));
InitLinearLinkedList(&rule_56->expressions);
rule_56->nonTerminal = parameter_type_list;
...
rule_58->expressions->info = pointerexpression;
PushLinearLinkedList(&rule_58->expressions);
...
rule_59->nonTerminal = direct_declarator;
PushLinearLinkedList(&rule_59->expressions);
rule_59->expressions->info = RIGHT_PARENexpression;
PushLinearLinkedList(&rule_59->expressions);
rule_59->expressions->info = IDENTIFIERexpression;
PushLinearLinkedList(&rule_59->expressions);
rule_59->expressions->info = INTexpression;
PushLinearLinkedList(&rule_59->expressions);
rule_59->expressions->info = LEFT_PARENexpression;
PushLinearLinkedList(&direct_declarator->rules);
direct_declarator->rules->info = rule_59;
...
rule_103->expressions->info = EQexpression;
PushLinearLinkedList(&rule_103->expressions);
rule_103->expressions->info = STARexpression;
PushLinearLinkedList(&assignment_operator->rules);
...
rule_104->expressions->info = EQexpression;
PushLinearLinkedList(&rule_104->expressions);
rule_104->expressions->info = SLASHexpression;
PushLinearLinkedList(&assignment_operator->rules);
...
rule_105->expressions->info = EQexpression;
PushLinearLinkedList(&rule_105->expressions);
rule_105->expressions->info = MODexpression;
PushLinearLinkedList(&assignment_operator->rules);
...
rule_106->expressions->info = EQexpression;
PushLinearLinkedList(&rule_106->expressions);
rule_106->expressions->info = PLUSexpression;
PushLinearLinkedList(&assignment_operator->rules);
...
rule_107->expressions->info = EQexpression;
PushLinearLinkedList(&rule_107->expressions);
rule_107->expressions->info = MINUSexpression;
PushLinearLinkedList(&assignment_operator->rules);
...
rule_113->nonTerminal = relational_expression;
PushLinearLinkedList(&rule_113->expressions);
rule_113->expressions->info = shift_expressionexpression;
PushLinearLinkedList(&relational_expression->rules);
relational_expression->rules->info = rule_113;
...
PushLinearLinkedList(&rule_114->expressions);
rule_114->expressions->info = GTexpression;
PushLinearLinkedList(&rule_114->expressions);
rule_114->expressions->info = relational_expressionexpression;
PushLinearLinkedList(&relational_expression->rules);
...
PushLinearLinkedList(&rule_115->expressions);
rule_115->expressions->info = LTexpression;
PushLinearLinkedList(&rule_115->expressions);
...
PushLinearLinkedList(&rule_116->expressions);
rule_116->expressions->info = GEexpression;
PushLinearLinkedList(&rule_116->expressions);
...
PushLinearLinkedList(&rule_117->expressions);
rule_117->expressions->info = LEexpression;
PushLinearLinkedList(&rule_117->expressions);
...
rule_118->nonTerminal = shift_expression;
PushLinearLinkedList(&rule_118->expressions);
rule_118->expressions->info = additive_expressionexpression;
PushLinearLinkedList(&shift_expression->rules);
shift_expression->rules->info = rule_118;
Rule *rule_119 = malloc(sizeof(Rule));
InitLinearLinkedList(&rule_119->expressions);
rule_119->nonTerminal = additive_expression;
PushLinearLinkedList(&rule_119->expressions);
rule_119->expressions->info = multiplicative_expressionexpression;
PushLinearLinkedList(&additive_expression->rules);
additive_expression->rules->info = rule_119;
...
PushLinearLinkedList(&rule_120->expressions);
rule_120->expressions->info = PLUSexpression;
PushLinearLinkedList(&rule_120->expressions);
rule_120->expressions->info = additive_expressionexpression;
PushLinearLinkedList(&additive_expression->rules);
...
PushLinearLinkedList(&rule_121->expressions);
rule_121->expressions->info = MINUSexpression;
PushLinearLinkedList(&rule_121->expressions);
...
rule_122->nonTerminal = multiplicative_expression;
PushLinearLinkedList(&rule_122->expressions);
rule_122->expressions->info = cast_expressionexpression;
PushLinearLinkedList(&multiplicative_expression->rules);
multiplicative_expression->rules->info = rule_122;
...
PushLinearLinkedList(&rule_123->expressions);
rule_123->expressions->info = STARexpression;
PushLinearLinkedList(&rule_123->expressions);
rule_123->expressions->info = multiplicative_expressionexpression;
PushLinearLinkedList(&multiplicative_expression->rules);
...
PushLinearLinkedList(&rule_124->expressions);
rule_124->expressions->info = SLASHexpression;
PushLinearLinkedList(&rule_124->expressions);
...
PushLinearLinkedList(&rule_125->expressions);
rule_125->expressions->info = MODexpression;
PushLinearLinkedList(&rule_125->expressions);
...
rule_126->nonTerminal = cast_expression;
PushLinearLinkedList(&rule_126->expressions);
rule_126->expressions->info = unary_expressionexpression;
PushLinearLinkedList(&cast_expression->rules);
cast_expression->rules->info = rule_126;
...
rule_127->expressions->info = cast_expressionexpression;
PushLinearLinkedList(&rule_127->expressions);
rule_127->expressions->info = RIGHT_PARENexpression;
PushLinearLinkedList(&rule_127->expressions);
rule_127->expressions->info = type_nameexpression;
PushLinearLinkedList(&rule_127->expressions);
rule_127->expressions->info = LEFT_PARENexpression;
PushLinearLinkedList(&cast_expression->rules);
cast_expression->rules->info = rule_127;
Rule *rule_128 = malloc(sizeof(Rule));
InitLinearLinkedList(&rule_128->expressions);
rule_128->nonTerminal = unary_operator;
PushLinearLinkedList(&rule_128->expressions);
rule_128->expressions->info = STARexpression;
PushLinearLinkedList(&unary_operator->rules);
unary_operator->rules->info = rule_128;
...
rule_129->expressions->info = PLUSexpression;
PushLinearLinkedList(&unary_operator->rules);
...
rule_130->expressions->info = MINUSexpression;
PushLinearLinkedList(&unary_operator->rules);
...
PushLinearLinkedList(&rule_133->expressions);
rule_133->expressions->info = PLUSexpression;
PushLinearLinkedList(&rule_133->expressions);
rule_133->expressions->info = PLUSexpression;
PushLinearLinkedList(&unary_expression->rules);
...
PushLinearLinkedList(&rule_134->expressions);
rule_134->expressions->info = MINUSexpression;
PushLinearLinkedList(&rule_134->expressions);
rule_134->expressions->info = MINUSexpression;
PushLinearLinkedList(&unary_expression->rules);
...
rule_135->expressions->info = cast_expressionexpression;
PushLinearLinkedList(&rule_135->expressions);
rule_135->expressions->info = unary_operatorexpression;
PushLinearLinkedList(&unary_expression->rules);
unary_expression->rules->info = rule_135;
Rule *rule_136 = malloc(sizeof(Rule));
InitLinearLinkedList(&rule_136->expressions);
rule_136->nonTerminal = argument_expression_list;
PushLinearLinkedList(&rule_136->expressions);
rule_136->expressions->info = assignment_expressionexpression;
PushLinearLinkedList(&argument_expression_list->rules);
argument_expression_list->rules->info = rule_136;
...
PushLinearLinkedList(&rule_137->expressions);
rule_137->expressions->info = COMMAexpression;
PushLinearLinkedList(&rule_137->expressions);
rule_137->expressions->info = argument_expression_listexpression;
PushLinearLinkedList(&argument_expression_list->rules);
argument_expression_list->rules->info = rule_137;
Rule *rule_138 = malloc(sizeof(Rule));
InitLinearLinkedList(&rule_138->expressions);
rule_138->nonTerminal = postfix_expression;
PushLinearLinkedList(&rule_138->expressions);
rule_138->expressions->info = primary_expressionexpression;
PushLinearLinkedList(&postfix_expression->rules);
postfix_expression->rules->info = rule_138;
...
rule_139->expressions->info = RIGHT_BRACKETexpression;
PushLinearLinkedList(&rule_139->expressions);
rule_139->expressions->info = expressionexpression;
PushLinearLinkedList(&rule_139->expressions);
rule_139->expressions->info = LEFT_BRACKETexpression;
PushLinearLinkedList(&rule_139->expressions);
rule_139->expressions->info = postfix_expressionexpression;
PushLinearLinkedList(&postfix_expression->rules);
...
rule_140->expressions->info = RIGHT_PARENexpression;
PushLinearLinkedList(&rule_140->expressions);
rule_140->expressions->info = LEFT_PARENexpression;
PushLinearLinkedList(&rule_140->expressions);
...
PushLinearLinkedList(&rule_141->expressions);
rule_141->expressions->info = argument_expression_listexpression;
PushLinearLinkedList(&rule_141->expressions);
...
rule_142->expressions->info = IDENTIFIERexpression;
PushLinearLinkedList(&rule_142->expressions);
rule_142->expressions->info = DOTexpression;
PushLinearLinkedList(&rule_142->expressions);
...
PushLinearLinkedList(&rule_143->expressions);
rule_143->expressions->info = ARROWexpression;
PushLinearLinkedList(&rule_143->expressions);
...
rule_144->expressions->info = PLUSexpression;
PushLinearLinkedList(&rule_144->expressions);
rule_144->expressions->info = PLUSexpression;
PushLinearLinkedList(&rule_144->expressions);
...
rule_145->expressions->info = MINUSexpression;
PushLinearLinkedList(&rule_145->expressions);
rule_145->expressions->info = MINUSexpression;
PushLinearLinkedList(&rule_145->expressions);
...
rule_146->nonTerminal = primary_expression;
PushLinearLinkedList(&rule_146->expressions);
rule_146->expressions->info = IDENTIFIERexpression;
PushLinearLinkedList(&primary_expression->rules);
primary_expression->rules->info = rule_146;
...
rule_147->expressions->info = INTEGER_LITERALexpression;
PushLinearLinkedList(&primary_expression->rules);
...
rule_148->expressions->info = FLOAT_LITERALexpression;
PushLinearLinkedList(&primary_expression->rules);
...
rule_149->expressions->info = STRING_LITERALexpression;
PushLinearLinkedList(&primary_expression->rules);
...
rule_150->expressions->info = RIGHT_PARENexpression;
PushLinearLinkedList(&rule_150->expressions);
rule_150->expressions->info = expressionexpression;
PushLinearLinkedList(&rule_150->expressions);
rule_150->expressions->info = LEFT_PARENexpression;
PushLinearLinkedList(&primary_expression->rules);
